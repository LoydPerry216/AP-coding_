# step 1. import libraries to help us
...
#print(team_stats.colums)

#bestRecord = teams_stats.sort_values(by="wins", ascending=False)
#print(bestRecord[['teams','wins','loses']].head())
...
teams = nfl.import_team_desc()
print(rec.merge(teams, left_on="team", right_on="team_abbr")[["team_name","wins","losses","ties"]].head(31))