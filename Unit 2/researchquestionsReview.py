...
'I believe this is question is a relation because it is trying to see if there is a relationship'
'between turnovers and win percentages'
"The defensive turnovers does not contribute to team wins"


'3. Who has the most passing yards of all time ? '
'Tom Brady has the most passing yards of all time in the NFl history.'